...
function logIncompatibleExportOptionValue(optionValue, keys2, entryModule) {
  return {
    code: INVALID_EXPORT_OPTION,
...
function logParseError(error2, moduleId) {
...
function logPluginError(error2, plugin, { hook, id } = {}) {
  ...
  if (!error2.pluginCode && code != null && (typeof code !== "string" || typeof code === "string" && !code.startsWith("PLUGIN_"))) {
...
var ExportDefaultDeclaration$1 = "ExportDefaultDeclaration";
var ExportNamedDeclaration$1 = "ExportNamedDeclaration";
var ExpressionStatement$1 = "ExpressionStatement";
var FunctionDeclaration$1 = "FunctionDeclaration";
...
var VariableDeclarator$1 = "VariableDeclarator";
var VariableDeclaration$1 = "VariableDeclaration";
...
var ChildScope = class _ChildScope extends Scope$1 {
  constructor(parent) {
    super();
...
function amd(magicString, { accessedGlobals, dependencies, exports, hasDefaultExport, hasExports, id, indent: t, intro, isEntryFacade, isModuleFacade, namedExportsMode, log, outro, snippets }, { amd: amd2, esModule, externalLiveBindings, freeze, interop, namespaceToStringTag, strict }) {
...
function iife(magicString, { accessedGlobals, dependencies, exports, hasDefaultExport, hasExports, indent: t, intro, namedExportsMode, log, outro, snippets }, { compact, esModule, extend: extend2, freeze, externalLiveBindings, globals, interop, name, namespaceToStringTag, strict }) {
...
function umd(magicString, { accessedGlobals, dependencies, exports, hasDefaultExport, hasExports, id, indent: t, intro, namedExportsMode, log, outro, snippets }, { amd: amd2, compact, esModule, extend: extend2, externalLiveBindings, freeze, interop, name, namespaceToStringTag, globals, noConflict, strict }) {
...
var getHashPlaceholderGenerator = () => {
  ...
  return (optionName, hashSize = defaultHashSize) => {
    ...
    if (placeholder.length > hashSize) {
      return error(logFailedValidation(`To generate hashes for this number of chunks (currently ${nextIndex2}), you need a minimum hash size of ${placeholder.length}, received ${hashSize}. Check the "${optionName}" option.`));
    }
    return placeholder;
  };
};
...
function getOptimizedChunks(initialChunks, numberOfEntries, minChunkSize, log) {
  ...
  minChunkSize > 1 && log("info", logOptimizeChunkStatus(initialChunks.length, chunkPartition.small.size, "Initially"));
...
var getInlineDynamicImports$1 = (config, log, strictDeprecations) => {
...
var getManualChunks$1 = (config, log, strictDeprecations) => {
...
var getMaxParallelFileOps = (config, log, strictDeprecations) => {
...
var getPreserveModules$1 = (config, log, strictDeprecations) => {
...
async function watchInternal(configs, emitter) {
  ...
  await loadFsEvents();
  const { Watcher } = await import("./watch-JDL5X5CI.js");
...
rollup/dist/es/shared/node-entry.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-EPV2VV73.js.map
